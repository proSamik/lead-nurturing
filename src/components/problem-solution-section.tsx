...
import { IconTarget, IconMail, IconTool, IconCheck, IconMail as IconMailOpen, IconLink, IconChartBar } from "@tabler/icons-react";
...
export function ProblemSolutionSection() {
  const problems = [
    {
      ...
      description: "Relying on rented platforms for audience runs the risk you'll lose them overnight.",
    },
    {
      icon: <IconMail className="h-8 w-8 text-red-500" />,
      title: "Hidden Monthly Costs",
      description: "Most email tools hide costs—hidden monthly plans hit creators hard.",
    },
    {
  ...
  const solutions = [
    ...
    },
    {
      ...
      description: "Track referrers (YouTube, Instagram, X, Reddit), sign‑ups, drop‑off rates",
      highlight: false,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-6xl font-bold mb-6">
            <span className="text-red-500">Problems</span> → <span className="text-blue-600">Solutions</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We've identified the pain points that creators face and built the perfect solution
          </p>
        </div>
        ...
        >
          ...
          <p className="text-gray-600 mb-6">
            Join thousands of creators who've made the switch to ownership over rental
          </p>
